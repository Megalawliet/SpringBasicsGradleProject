...
@RestController
@RequestMapping("test2") //le introducimos la ruta principal para que acceda al programa una vez puestos el host y el puerto.
@CrossOrigin
public class MyService {
	
	@GetMapping("/Hola/{name}") //mapeamos la ruta que le pondremos en el navegador despues de test
